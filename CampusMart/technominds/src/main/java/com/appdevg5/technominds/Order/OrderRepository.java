...
public interface OrderRepository extends JpaRepository<OrderEntity, Integer> {
    ...
    /**
     * Finds all orders that are associated with a given product id via the linked tradeOffer.
     * Matches OrderEntity.tradeOffer.product.id
     */
    List<OrderEntity> findByTradeOffer_Product_Id(Integer productId);
}