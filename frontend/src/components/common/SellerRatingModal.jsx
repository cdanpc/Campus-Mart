...
export default function SellerRatingModal({ isOpen, onClose, seller, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Prepare rating data matching ERD reviews table
    const ratingData = {
      review_id: null, // Generated by backend
      reviewer_profile_id: 1, // TODO: Get from auth context
      reviewed_profile_id: seller.profile_id,
      product_id: null, // General seller review, not product-specific
      order_id: null, // General seller review
      rating: rating,
    ...
    <div className="rating-modal-overlay" onClick={handleClose}>
      <div className="rating-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="rating-modal__header no-print">
          <h2 className="rating-modal__title">Rate Seller</h2>
          <button 
            onClick={handleClose} 
          ...
          <div className="rating-product">
            ...
            <div className="rating-product__details">
              ...
              <p className="rating-product__seller">
                Current Rating: {seller.seller_rating}/5.0 ({seller.total_reviews} reviews)
              </p>
            </div>
          </div>
