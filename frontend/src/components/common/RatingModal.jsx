...
export default function RatingModal({ isOpen, onClose, orderData, onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    const ratingData = {
      ...
      reviewer_profile_id: orderData.buyer_profile_id,
      reviewed_profile_id: orderData.seller_profile_id,
        ...
        <div className="rating-content">
          ...
          <div className="rating-product">
            ...
            <div className="rating-product__details">
              <h3 className="rating-product__name">{orderData.product.name}</h3>
              <p className="rating-product__seller">
                Sold by: {orderData.seller.first_name} {orderData.seller.last_name}
              </p>
            </div>
          </div>
